/*
 * CS Photo Selector
 * @original author: Carson Shold (@cshold)
*/
...
var CSPhotoSelector = (function(module, $) {
	...
	// Private functions
	$getAlbumById, $getPhotoById, buildAlbumSelector, buildPhotoSelector, sortPhotos;
	...
	newInstance = function(options) {
		...
		hidePhotoSelector = function() {
			...
			$('.CSPhotoSelector_album').removeClass('CSPhotoSelector_photoSelected');
		};
